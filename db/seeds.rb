...
#contas analiticas
 ...
 anal26 = AnalyticAccount.new(id: 26, name:"Salarios Ordenados", code: 1, second_synthetic_account: scd34 )
 anal27 = AnalyticAccount.new(id: 27, name:"Encargos Sociais", code: 2, second_synthetic_account: scd34 )
 anal28 = AnalyticAccount.new(id: 28, name:"Indenizações e aviso prévio", code: 3, second_synthetic_account: scd34 )
 anal29 = AnalyticAccount.new(id: 29, name:"Contador", code: 4, second_synthetic_account: scd34 )
 anal30 = AnalyticAccount.new(id: 30, name:"Serviço prestado por Terceiros", code: 5, second_synthetic_account: scd34 )
 anal31 = AnalyticAccount.new(id: 31, name:"Manutenção e Reparo", code: 6, second_synthetic_account: scd34 )
 anal32 = AnalyticAccount.new(id: 32, name:"Material de Expediente", code: 7, second_synthetic_account: scd34 )
 anal33 = AnalyticAccount.new(id: 33, name:"Conservação e Limpeza", code: 8, second_synthetic_account: scd34 )
 anal34 = AnalyticAccount.new(id: 34, name:"Seguros", code: 9, second_synthetic_account: scd34 )
 anal35 = AnalyticAccount.new(id: 35, name:"Energia eletrica", code: 10, second_synthetic_account: scd34 )
 anal36 = AnalyticAccount.new(id: 36, name:"Comunicação", code: 11, second_synthetic_account: scd34 )
 anal37 = AnalyticAccount.new(id: 37, name:"Despesas com Alimentação", code: 12, second_synthetic_account: scd34 )
 anal38 = AnalyticAccount.new(id: 38, name:"Despesas Diversas", code: 13, second_synthetic_account: scd34 )
