...
class EnterprisesControllerTest < ActionController::TestCase
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post :create, enterprise: { cnpj: @enterprise.cnpj, field_of_work: @enterprise.field_of_work, name: @enterprise.name }
    end
  ...
  test "should update enterprise" do
    patch :update, id: @enterprise, enterprise: { cnpj: @enterprise.cnpj, field_of_work: @enterprise.field_of_work, name: @enterprise.name }
    assert_redirected_to enterprise_path(assigns(:enterprise))
  end
